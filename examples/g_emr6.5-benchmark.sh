...
jobname="tpcds-benchmark-emr-eks-3t-arm"
...
--job-driver '{
  "sparkSubmitJobDriver": {
      ...
      "sparkSubmitParameters": "--class com.amazonaws.eks.tpcds.BenchmarkSQL --conf spark.driver.cores=4 --conf spark.driver.memory=4g --conf spark.executor.cores=4 --conf spark.executor.memory=4g --conf spark.executor.instances=60"}}' \
